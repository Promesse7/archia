...
export default function ArchaeologicalReconstructionViewer({
  classification = null,
  ...
  const [originalMeshRef, setOriginalMeshRef] = useState(null);
