...
export const FragmentGrid = React.forwardRef<HTMLDivElement, FragmentGridProps>(
  ({ 
    fragments, 
    selectedFragments, 
    onSelectFragment, 
    ...
    const handleFragmentSelect = useCallback((fragmentId: string) => {
      onSelectFragment(fragmentId);
    }, [onSelectFragment]);
    
    const handleFragmentView = useCallback((fragmentId: string) => {
