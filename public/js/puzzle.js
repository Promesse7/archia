...
class Puzzle{
    constructor(obj){
        ...
        // set canvas width and height based on element size
        const rect = this.canvas.getBoundingClientRect();
        this.canvas.width = rect.width * this.scaleMultiplier;
        this.canvas.height = rect.height * this.scaleMultiplier;
    ...
    mousedown(e){
        ...
        if(this.selected!=null){
            ...
            this.selected.offset = {
                x: (e.clientX - rect.left) * this.scaleMultiplier - this.selected.x,
                y: (e.clientY - rect.top) * this.scaleMultiplier - this.selected.y
            }
        }
    }
     ...
     */
    draw(){
        // update canvas width and height based on element size
        const rect = this.canvas.getBoundingClientRect();
        this.canvas.width = rect.width * this.scaleMultiplier;
        this.canvas.height = rect.height * this.scaleMultiplier;
